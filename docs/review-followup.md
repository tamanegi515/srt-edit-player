...
On 2026-09-05 the integrated Chromium suite passed 92 tests and the Vite production build passed. Layout viewports covered 1664x1000, 1426x1209, 1366x768, 1000x700 and 800x700; the ribbon remains below its 155px ceiling. Color-picker edge checks additionally cover 768x900, 390x844 and 390x320.
